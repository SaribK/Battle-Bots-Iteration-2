...
public class BattleBotArena extends JPanel implements MouseListener, MouseWheelListener, MouseMotionListener, ActionListener, Runnable {
	 ...
	 */
	public static final int RIGHT_EDGE = 1200;//1260; //ROWBOTTOM - changed from 700// also arena panel width
	/**
	 * Bottom edge of the screen
	 */
	public static final int BOTTOM_EDGE = 500;//896; //ROWBOTTOM - changed from 500// arena panel height is this constant + TEXT_BUFFER
	/**
	 ...
	 */
	public static final int 	NUM_BOTS = 14;//ROWBOTTOM NOV 6 2017 Changed to 25
	/**
